...
void BN_UI::SetStyleTokyoNight()
{
  ...
  style.Colors[ImGuiCol_Text] = ImVec4(0.75f, 0.79f, 0.96f, 1.0f);
  style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.60f, 0.64f, 0.80f, 1.0f);
  style.Colors[ImGuiCol_WindowBg] = ImVec4(0.10f, 0.10f, 0.14f, 1.0f);
  style.Colors[ImGuiCol_ChildBg] = ImVec4(0.10f, 0.10f, 0.14f, 1.0f);
  style.Colors[ImGuiCol_PopupBg] = ImVec4(0.14f, 0.15f, 0.23f, 1.0f);
  style.Colors[ImGuiCol_Border] = ImVec4(0.33f, 0.37f, 0.53f, 1.0f);
  style.Colors[ImGuiCol_FrameBg] = ImVec4(0.10f, 0.10f, 0.14f, 1.0f);
  style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.14f, 0.15f, 0.23f, 1.0f);
  style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.14f, 0.15f, 0.23f, 1.0f);
  style.Colors[ImGuiCol_TitleBg] = ImVec4(0.09f, 0.09f, 0.14f, 1.0f);
  style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.09f, 0.09f, 0.14f, 1.0f);
  style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.09f, 0.09f, 0.14f, 1.0f);
  style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.21f, 0.22f, 0.3f, 1.0f);
