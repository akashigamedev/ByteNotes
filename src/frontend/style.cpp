...
void BN_UI::SetStyleCatppuccin()
{
  ...
  style.Colors[ImGuiCol_Button] = ImVec4(0.54f, 0.83f, 0.79f, 1.0f);
  style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.37f, 0.67f, 0.73f, 1.0f);
  style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.37f, 0.67f, 0.73f, 1.0f);
}
